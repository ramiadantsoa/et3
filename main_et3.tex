\title{Specialization and extinction threshold}
\date{\vspace{-5ex}}
...
2) Anthropogenic disturbance in tropical forests can double biodiversity loss from deforestation Jos Barlow Nature
